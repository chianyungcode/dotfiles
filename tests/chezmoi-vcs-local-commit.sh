...
[[ $(git config --file "$git_config" --get user.name) == chianyungcode-server ]]
[[ $(git config --file "$git_config" --get user.email) == chianyungcode-server@local.invalid ]]
...
[[ "$git_identity" == 'chianyungcode-server|chianyungcode-server@local.invalid|emergency' ]]
...
[[ "$jj_identity" == 'chianyungcode-server|chianyungcode-server@local.invalid|emergency' ]]
