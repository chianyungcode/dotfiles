...
obsidian_dir="$HOME/Documents/vault-obsidian"
...
# WINDOW 3
pueue add -g "$PUEUE_GROUP" "tmux new-window -t \"$SESSION_NAME\":3 -n \"obsidian\" -c \"$obsidian_dir\""
pueue add -g "$PUEUE_GROUP" sleep 5

pueue add -g "$PUEUE_GROUP" "tmux send-keys -t \"$SESSION_NAME\":3.1 nvim C-m"
pueue add -g "$PUEUE_GROUP" sleep 3
