...
function __orb_prepare_completions
    ...
    set -l results (__orb_perform_completion)
    __orb_debug "Completion results: $results"
    ...
    set --global __orb_comp_results $results[1..-2]
...
complete -c orb -n __orb_prepare_completions -f -a '$__orb_comp_results'
